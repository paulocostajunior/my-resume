let resumeData = {
    "name" : "Paulo César Costa Jr.",
    "role" : "Full Stack Web Developer",
    "email" : "costapaulojr@gmail.com",
    "country" : "Brazil",
    "socialLinks":[
        {
          "name":"linkedin",
          "url":"https://www.linkedin.com/in/paulo-costa-jr-048470144/",
    ...
    "education" : [
        {
            ...
            "place" : "Centro Universitário Barão de Mauá • Jan 2016 / June 2019"
        },
        {
    ...
    "jobs" : [
        ...
        },
        {
            ...
            "date" : "Ribeirão Preto - São Paulo (August/2016 – May/2018)",
            "description" : `I worked as a Full Stack Web Developer using PHP, HTML, CSS, Javascript(jQuery) and SQL Server.`
        },
    ],
    "techSkills" : [
        {
            "coding" : "HTML, CSS, Javascript (React, React Native, Redux, Nodejs), Angular, PHP, .NET, SQL Server, MySQL, Mongodb",
            "tools" : "Git, NPM/Yarn/Bower, Trello, Photoshop, Illustrator.",
